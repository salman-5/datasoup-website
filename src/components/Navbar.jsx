...
function Navbar() {
  ...
  return (
    <motion.nav
    //removed fixed
      class={`bg-[#cb82b7] fixed  z-50  top-0 left-0 flex items-center justify-around flex-wrap  p-4 w-full transform transition duration-300 bg-transparent ${navbarBg}`}
    >
