...
function BenefitsCard({svg,text}) {
  return (
    ...
    //     <svg viewBox="0 0 1024 1024" className="h-5 w-5 text-gray-600">
    //       <path
    ...
    //       ></path>
    //     </svg>
    //     <h2 className="not-italic text-center font-medium">{props.title}</h2>
    //     <span className="text-center">{props.description}</span>
    //     <span className="text-xs font-medium">{props.action}</span>
    //   </div>
    // </div>
    <div className="bg-white border-gray-950 h-[400px] rounded-xl p-8 space-y-6">
