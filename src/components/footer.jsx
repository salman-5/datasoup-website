...
<div className="w-[191.34px] h-[42px] pl-[7.34px] pb-2.5 left-[20px] top-[377px]  flex-col justify-start items-start inline-flex">
                <div className="w-[184px] h-8 justify-center items-center inline-flex">
