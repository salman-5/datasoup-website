    ...
    <div className="mt-4 grid lg:grid-cols-2 grid-cols-1 px-8">
      <div className='flex flex-col justify-evenly gap-3'>
        ...
        <div className='flex justify-center'>
          ...
          <div className="p-4 bg-neutral-100 rounded-[30px] border border-teal-900 f text-teal-900 text-[17px] font-normal font-inter leading-normal">Watch Demo</div>
          <div className="p-4 bg-teal-900 rounded-[30px] border border-teal-900 flex text-white text-base font-normal font-inter leading-normal">Try for Free</div>
        </div>
